<%@ Page Title="" Language="C#" MasterPageFile="~/WithNav.Master" AutoEventWireup="true" CodeBehind="SophmoreApp.aspx.cs" Inherits="Capstone2.WebForm5" %>
...
<div class="col-lg-6 col-md-6">
                    ...
                    <asp:DropDownList class="form-control" ID="CitizenshipDropDownList" runat="server" style="width:100%; margin-top:10px; margin-bottom: 20px; position: relative" OnSelectedIndexChanged="CitizenshipDropDownList_SelectedIndexChanged" AutoPostBack="true">
                    <asp:ListItem Value="Select"></asp:ListItem>
                    ...
                    <asp:Button OnClientClick="SaveButton()" ID="SaveButton" class="btn btn-primary" style="margin-top: 20px; margin-bottom: 10px; width: 100%; background-color:#9E1B34" runat="server" Text="Save"/>
                        <script>
                            function SaveButton() {
                                alert("You Have Saved Your Application");
                            }
                        </script>

...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid">
        ...
        <div class="row" style="position: relative">
            ...
            <div class="col-lg-3 cl-md-3"></div>
            <div class="col-lg-6 cl-md-6">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body" style="padding-left: 20px; color: black">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <%--</div>--%>
                            <%--<div class="col-lg-12 col-md-12">--%>
                            <asp:Button class="btn btn-sm" ID="SearchButton" runat="server" Text="Search" BorderColor="#9E1B34" Style="width: 100%; margin-top: 30px; margin-bottom: 15px" BackColor="#9E1B34" ForeColor="White" />
                            <%-- </div>--%>
                            <%-- <div class="col-lg-12 col-md-6" style="width: 66%">--%>

                            <%--<div class="col-lg-12 col-md-12">--%>
                            <asp:Button class="btn btn-sm" ID="SelectButton" runat="server" BorderColor="#9E1B34" Text="Download Selected" Style="width: 100%; margin-bottom: 15px" BackColor="#9E1B34" ForeColor="White" />
                        <%--</div>--%>
                        <%-- <div class="col-lg-4 col-md-6" style="width: 66%">
                     </div>--%>
                        <%--<div class="col-lg-12 col-md-12">--%>
                            <asp:Button class="btn btn-sm" ID="ExportDataButton" runat="server" BorderColor="#9E1B34" Text="Export Data" Style="width: 100%; margin-bottom: 20px" BackColor="#9E1B34" ForeColor="White" />
                        <%--</div>--%>
                    </div>
                    ...
                    <asp:GridView ID="ViewHistoricalGridView" runat="server" Style="margin-bottom: 0%; margin-left: auto; margin-right: auto; position: relative; width: 96%" AutoGenerateColumns="False" Width="800px">
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
